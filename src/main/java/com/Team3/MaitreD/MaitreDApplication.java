...
public class MaitreDApplication {
	...
	@Bean
	CommandLineRunner creawteRoles(RoleRepository roleRepository, UserRepository userRepository,
			RestaurantRepository restaurantRepository, PasswordEncoder passwordEncode) {
		return args -> {
			...
			if (!restaurantRepository.findByRestaurantName("Marty's Pizza").isPresent()) {
				...
				restaurantRepository.save(new Restaurant("Marty's Pizza", "717 Liberty Ave., Columbia, MD, 21075",
						"1-805-717-4226", "Italian", "09:00", "21:00", martys));
				...
				restaurantRepository.save(new Restaurant("Sandwich Joe", "113 Main Street, Columbia, MD, 21075",
						"1-805-844-4895", "Sandwich", "09:00", "21:00", sandwich));
				...
				restaurantRepository.save(new Restaurant("Houston BBQ", "29 W. Laurel Avenue, Columbia, MD, 21075",
						"1-805-944-4895", "American", "09:00", "21:00", bbq));
				...
				restaurantRepository.save(new Restaurant("Shanghai Kitchen", "12 Something Street, Columbia, MD, 21075",
						"1-302-844-4895", "Chinese", "09:00", "21:00", china));
				...
				restaurantRepository.save(new Restaurant("Au revoir", "1100 Thomas Ave, Columbia, MD, 21075",
						"1-304-844-4895", "French", "09:00", "21:00", french));
				...
				restaurantRepository.save(new Restaurant("Royal Curry", "944 55th Avenue, Columbia, MD, 21075",
						"1-544-844-4895", "Indian", "09:00", "21:00", india));
				...
				restaurantRepository.save(new Restaurant("La Chiquita", "518 W. Laurel Avenue, Columbia, MD, 21075",
						"1-250-844-4895", "Mexican", "09:00", "21:00", mexican));
				...
				restaurantRepository.save(new Restaurant("Trattoria Roma", "12 Northshore Drive, Columbia, MD, 21075",
						"1-350-844-4895", "Italian", "09:00", "21:00", pasta));
				...
				restaurantRepository.save(new Restaurant("Empire Steakhouse", "255 Main Street, Columbia, MD, 21075",
						"1-777-844-4895", "American", "09:00", "21:00", steak));
				...
				restaurantRepository.save(new Restaurant("Ototo", "150 Shibuya Street, Columbia, MD, 21075",
						"1-888-844-4895", "Japanese", "09:00", "21:00", sushi));
			}
			...
			if (!userRepository.findByUsername("Account1").isPresent()) {
				...
				userRepository.save(new ApplicationUser(null, "Account1", "Account1@gmail.com",
						passwordEncode.encode("Password1!"), authorities,
						restaurantRepository.findByRestaurantName("Marty's Pizza").get().getRestaurantID()));

				userRepository.save(new ApplicationUser(null, "Account2", "Account2@gmail.com",
						passwordEncode.encode("Password1!"), authorities,
						restaurantRepository.findByRestaurantName("Sandwich Joe").get().getRestaurantID()));

				userRepository.save(new ApplicationUser(null, "Account3", "Account3@gmail.com",
						passwordEncode.encode("Password1!"), authorities,
						restaurantRepository.findByRestaurantName("Houston BBQ").get().getRestaurantID()));

				userRepository.save(new ApplicationUser(null, "Account4", "Account4@gmail.com",
						passwordEncode.encode("Password1!"), authorities,
						restaurantRepository.findByRestaurantName("Shanghai Kitchen").get().getRestaurantID()));

				userRepository.save(new ApplicationUser(null, "Account5", "Account5@gmail.com",
						passwordEncode.encode("Password1!"), authorities,
						restaurantRepository.findByRestaurantName("Au revoir").get().getRestaurantID()));

				userRepository.save(new ApplicationUser(null, "Account6", "Account6@gmail.com",
						passwordEncode.encode("Password1!"), authorities,
						restaurantRepository.findByRestaurantName("Royal Curry").get().getRestaurantID()));

				userRepository.save(new ApplicationUser(null, "Account7", "Account7@gmail.com",
						passwordEncode.encode("Password1!"), authorities,
						restaurantRepository.findByRestaurantName("La Chiquita").get().getRestaurantID()));

				userRepository.save(new ApplicationUser(null, "Account8", "Account8@gmail.com",
						passwordEncode.encode("Password1!"), authorities,
						restaurantRepository.findByRestaurantName("Trattoria Roma").get().getRestaurantID()));

				userRepository.save(new ApplicationUser(null, "Account9", "Account9@gmail.com",
						passwordEncode.encode("Password1!"), authorities,
						restaurantRepository.findByRestaurantName("Empire Steakhouse").get().getRestaurantID()));

				userRepository.save(new ApplicationUser(null, "Account10", "Account10@gmail.com",
						passwordEncode.encode("Password1!"), authorities,
